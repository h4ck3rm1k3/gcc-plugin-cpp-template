...
public:
   ...
   */
  Return call_type_ERROR_MARK (tree b)
  {
    return Default ();
  }
  Return call_type_IDENTIFIER_NODE (tree b)
  {
    return Default ();
  }
  Return call_type_TREE_LIST (tree b)
  {
    return Default ();
  }
  Return call_type_TREE_VEC (tree b)
  {
    return Default ();
  }
  Return call_type_BLOCK (tree b)
  {
    return Default ();
  }
  Return call_type_OFFSET_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_ENUMERAL_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_BOOLEAN_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_INTEGER_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_REAL_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_POINTER_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_REFERENCE_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_NULLPTR_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_FIXED_POINT_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_COMPLEX_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_VECTOR_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_ARRAY_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_RECORD_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_UNION_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_QUAL_UNION_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_VOID_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_POINTER_BOUNDS_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_FUNCTION_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_METHOD_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_LANG_TYPE (tree b)
  {
    return Default ();
  }
  Return call_type_VOID_CST (tree b)
  {
    return Default ();
  }
  Return call_type_INTEGER_CST (tree b)
  {
    return Default ();
  }
  Return call_type_REAL_CST (tree b)
  {
    return Default ();
  }
  Return call_type_FIXED_CST (tree b)
  {
    return Default ();
  }
  Return call_type_COMPLEX_CST (tree b)
  {
    return Default ();
  }
  Return call_type_VECTOR_CST (tree b)
  {
    return Default ();
  }
  Return call_type_STRING_CST (tree b)
  {
    return Default ();
  }
  Return call_type_FUNCTION_DECL (tree b)
  {
    return Default ();
  }
  Return call_type_LABEL_DECL (tree b)
  {
    return Default ();
  }
  Return call_type_FIELD_DECL (tree b)
  {
    return Default ();
  }
  Return call_type_VAR_DECL (tree b)
  {
    return Default ();
  }
  Return call_type_CONST_DECL (tree b)
  {
    return Default ();
  }
  Return call_type_PARM_DECL (tree b)
  {
    return Default ();
  }
  Return call_type_TYPE_DECL (tree b)
  {
    return Default ();
  }
  Return call_type_RESULT_DECL (tree b)
  {
    return Default ();
  }
  Return call_type_DEBUG_EXPR_DECL (tree b)
  {
    return Default ();
  }
  Return call_type_NAMESPACE_DECL (tree b)
  {
    return Default ();
  }
  Return call_type_IMPORTED_DECL (tree b)
  {
    return Default ();
  }
  Return call_type_NAMELIST_DECL (tree b)
  {
    return Default ();
  }
  Return call_type_TRANSLATION_UNIT_DECL (tree b)
  {
    return Default ();
  }
  Return call_type_COMPONENT_REF (tree b)
  {
    return Default ();
  }
  Return call_type_BIT_FIELD_REF (tree b)
  {
    return Default ();
  }
  Return call_type_ARRAY_REF (tree b)
  {
    return Default ();
  }
  Return call_type_ARRAY_RANGE_REF (tree b)
  {
    return Default ();
  }
  Return call_type_REALPART_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_IMAGPART_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VIEW_CONVERT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_INDIRECT_REF (tree b)
  {
    return Default ();
  }
  Return call_type_OBJ_TYPE_REF (tree b)
  {
    return Default ();
  }
  Return call_type_CONSTRUCTOR (tree b)
  {
    return Default ();
  }
  Return call_type_COMPOUND_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_MODIFY_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_INIT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_TARGET_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_COND_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_COND_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_PERM_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_BIND_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_CALL_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_WITH_CLEANUP_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_CLEANUP_POINT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_PLACEHOLDER_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_PLUS_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_MINUS_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_MULT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_POINTER_PLUS_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_MULT_HIGHPART_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_TRUNC_DIV_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_CEIL_DIV_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_FLOOR_DIV_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_ROUND_DIV_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_TRUNC_MOD_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_CEIL_MOD_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_FLOOR_MOD_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_ROUND_MOD_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_RDIV_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_EXACT_DIV_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_FIX_TRUNC_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_FLOAT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_NEGATE_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_MIN_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_MAX_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_ABS_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_LSHIFT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_RSHIFT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_LROTATE_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_RROTATE_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_BIT_IOR_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_BIT_XOR_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_BIT_AND_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_BIT_NOT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_TRUTH_ANDIF_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_TRUTH_ORIF_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_TRUTH_AND_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_TRUTH_OR_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_TRUTH_XOR_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_TRUTH_NOT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_LT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_LE_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_GT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_GE_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_EQ_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_NE_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_UNORDERED_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_ORDERED_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_UNLT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_UNLE_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_UNGT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_UNGE_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_UNEQ_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_LTGT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_RANGE_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_PAREN_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_CONVERT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_ADDR_SPACE_CONVERT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_FIXED_CONVERT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_NOP_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_NON_LVALUE_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_COMPOUND_LITERAL_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_SAVE_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_ADDR_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_FDESC_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_COMPLEX_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_CONJ_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_PREDECREMENT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_PREINCREMENT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_POSTDECREMENT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_POSTINCREMENT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VA_ARG_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_TRY_CATCH_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_TRY_FINALLY_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_DECL_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_LABEL_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_GOTO_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_RETURN_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_EXIT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_LOOP_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_SWITCH_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_CASE_LABEL_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_ASM_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_SSA_NAME (tree b)
  {
    return Default ();
  }
  Return call_type_CATCH_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_EH_FILTER_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_SCEV_KNOWN (tree b)
  {
    return Default ();
  }
  Return call_type_SCEV_NOT_KNOWN (tree b)
  {
    return Default ();
  }
  Return call_type_POLYNOMIAL_CHREC (tree b)
  {
    return Default ();
  }
  Return call_type_STATEMENT_LIST (tree b)
  {
    return Default ();
  }
  Return call_type_ASSERT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_TREE_BINFO (tree b)
  {
    return Default ();
  }
  Return call_type_WITH_SIZE_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_REALIGN_LOAD_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_TARGET_MEM_REF (tree b)
  {
    return Default ();
  }
  Return call_type_MEM_REF (tree b)
  {
    return Default ();
  }
  Return call_type_OACC_PARALLEL (tree b)
  {
    return Default ();
  }
  Return call_type_OACC_KERNELS (tree b)
  {
    return Default ();
  }
  Return call_type_OACC_DATA (tree b)
  {
    return Default ();
  }
  Return call_type_OACC_HOST_DATA (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_PARALLEL (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_TASK (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_FOR (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_SIMD (tree b)
  {
    return Default ();
  }
  Return call_type_CILK_SIMD (tree b)
  {
    return Default ();
  }
  Return call_type_CILK_FOR (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_DISTRIBUTE (tree b)
  {
    return Default ();
  }
  Return call_type_OACC_LOOP (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_TEAMS (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_TARGET_DATA (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_TARGET (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_SECTIONS (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_SINGLE (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_SECTION (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_MASTER (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_TASKGROUP (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_ORDERED (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_CRITICAL (tree b)
  {
    return Default ();
  }
  Return call_type_OACC_CACHE (tree b)
  {
    return Default ();
  }
  Return call_type_OACC_DECLARE (tree b)
  {
    return Default ();
  }
  Return call_type_OACC_ENTER_DATA (tree b)
  {
    return Default ();
  }
  Return call_type_OACC_EXIT_DATA (tree b)
  {
    return Default ();
  }
  Return call_type_OACC_UPDATE (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_TARGET_UPDATE (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_ATOMIC (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_ATOMIC_READ (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_ATOMIC_CAPTURE_OLD (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_ATOMIC_CAPTURE_NEW (tree b)
  {
    return Default ();
  }
  Return call_type_OMP_CLAUSE (tree b)
  {
    return Default ();
  }
  Return call_type_TRANSACTION_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_REDUC_MAX_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_REDUC_MIN_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_REDUC_PLUS_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_DOT_PROD_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_WIDEN_SUM_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_SAD_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_WIDEN_MULT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_WIDEN_MULT_PLUS_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_WIDEN_MULT_MINUS_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_WIDEN_LSHIFT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_FMA_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_WIDEN_MULT_HI_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_WIDEN_MULT_LO_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_WIDEN_MULT_EVEN_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_WIDEN_MULT_ODD_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_UNPACK_HI_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_UNPACK_LO_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_UNPACK_FLOAT_HI_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_UNPACK_FLOAT_LO_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_PACK_TRUNC_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_PACK_SAT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_PACK_FIX_TRUNC_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_WIDEN_LSHIFT_HI_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_VEC_WIDEN_LSHIFT_LO_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_PREDICT_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_OPTIMIZATION_NODE (tree b)
  {
    return Default ();
  }
  Return call_type_TARGET_OPTION_NODE (tree b)
  {
    return Default ();
  }
  Return call_type_ANNOTATE_EXPR (tree b)
  {
    return Default ();
  }
  Return call_type_CILK_SPAWN_STMT (tree b)
  {
    return Default ();
  }
  Return call_type_CILK_SYNC_STMT (tree b)
  {
    return Default ();
  }
