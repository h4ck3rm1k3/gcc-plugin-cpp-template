...
#include "category_implementation_type.hpp"
TC_CATEGORY_IMPLEMENTATION_TYPE aCATEGORY_IMPLEMENTATION_TYPE;

void
TC_CATEGORY_IMPLEMENTATION_TYPE::finish_type (tree t)
{
  cerr << "finish_type: CATEGORY_IMPLEMENTATION_TYPE" << t << endl;
};

void
TC_CATEGORY_IMPLEMENTATION_TYPE::finish_decl (tree t)
{
  cerr << "finish_decl: CATEGORY_IMPLEMENTATION_TYPE" << t << endl;
};

void
TC_CATEGORY_IMPLEMENTATION_TYPE::finish_unit (tree t)
{
