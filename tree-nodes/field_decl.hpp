...
class TC_FIELD_DECL:public TCWrapper < FIELD_DECL >
{
  ...
  static bool get_bit_field (TC_FIELD_DECL * self, tree t)
  {
    return self->BIT_FIELD_TYPE (t);
  }
  ...
  tree FIELD_CONTEXT (tree t)
  {
    return DECL_FIELD_CONTEXT (t);
  }

  tree FIELD_OFFSET (tree t)
  {
    return DECL_FIELD_OFFSET (t);
  }
  tree FIELD_BIT_OFFSET (tree t)
  {
    return DECL_FIELD_BIT_OFFSET (t);
  }

  long unsigned int FIELD_OFFSET_I (tree t);
  long unsigned int FIELD_BIT_OFFSET_I (tree t);

  tree BIT_FIELD_TYPE (tree t)
  {
    return DECL_BIT_FIELD_TYPE (t);
  }
  int OFFSET_ALIGN (tree t)
  {
    return DECL_OFFSET_ALIGN (t);
  }
