...
void
TC_IDENTIFIER_NODE::finish_type (tree t)
{
  cerr << "finish_type: IDENTIFIER_NODE" << t << endl;
};

void
TC_IDENTIFIER_NODE::finish_decl (tree t)
{
  cerr << "finish_decl: IDENTIFIER_NODE" << t << endl;
};

void
TC_IDENTIFIER_NODE::finish_unit (tree t)
{
...
const char *
TC_IDENTIFIER_NODE::id_str (tree_node * t)
{
  //check_type(t);
...
const char *
TC_IDENTIFIER_NODE::id (tree_node * t)
{
  if (!t)
    return "NULL";
  return id_str (t);
