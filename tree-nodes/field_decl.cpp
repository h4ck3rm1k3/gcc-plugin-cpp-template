...
tree
TC_FIELD_DECL::name (tree t)
{
  return DECL_NAME (t);
}

const char *
TC_FIELD_DECL::process_name (tree t)
{
...
const char *
TC_FIELD_DECL::finish_type_field (TC_FIELD_DECL * self, tree f)
{
...
long unsigned int
TC_FIELD_DECL::get_offset (TC_FIELD_DECL * self, tree f)
{
...
long unsigned int
TC_FIELD_DECL::get_bit_offset (TC_FIELD_DECL * self, tree f)
{
  return self->FIELD_BIT_OFFSET_I (f);
}

long unsigned int
TC_FIELD_DECL::get_bit_size (TC_FIELD_DECL * self, tree f)
{
  //  return 1; //TODO:
...
void
TC_FIELD_DECL::finish_type (tree t)
{
...
void
TC_FIELD_DECL::finish_decl (tree t)
{
  std::cerr << "TC_FIELD_DECL::finish_decl" << std::endl;
}

void
TC_FIELD_DECL::finish_unit (tree t)
{
}

long unsigned int
TC_FIELD_DECL::FIELD_OFFSET_I (tree t)
{
...
long unsigned int
TC_FIELD_DECL::FIELD_BIT_OFFSET_I (tree t)
{
